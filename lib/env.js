...
const DEFAULT_SUPABASE_URL = "https://pxhkotgxqxggukiswzxk.supabase.co";
// Supabase publishable keys are designed for browser/public use with RLS.
const DEFAULT_SUPABASE_PUBLISHABLE_KEY = "sb_publishable_mAhG2sFiVnQDZElttyTNKA_GIDTKpZT";
...
function getSupabaseUrl() {
  return getEnv("NEXT_PUBLIC_SUPABASE_URL") || getEnv("SUPABASE_URL") || DEFAULT_SUPABASE_URL;
}

function getSupabasePublicKey() {
  return getEnv("NEXT_PUBLIC_SUPABASE_ANON_KEY") || getEnv("NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY") || DEFAULT_SUPABASE_PUBLISHABLE_KEY;
}
